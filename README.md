...
These metrics are decent, with all metrics hovering around 80%. I fit a LightGBM model next to see if we can improve.



The key takeaway is again that if rainfall is low during the month of May the farmers should water the crops with the water collected in their cisterns. 
