...
The total production and production per plant are highly correlated with year because Café Casa Martinez has been progressively renewing fields each year and have not yet reached the stable equilibrium that will be achieved after all fields are renewed on schedule. The total number of plants also happens to be correlated with year because they have been sowing new lots progressively with year. In the coming years these correlations will drop away because they will be on the optimal renewal schedule, and they will run out of free lots to plant. **These correlations illustrate our first key takeaway. It is more important to stick with the renewal schedule than anything else, even rainfall.**
